...
export async function initiatePayment(data: number) {
    ...
    // Here I am generating random id you can send the id of the product you are selling or anything else.
    ...
    const payload = {
        ...
        amount: 100 * data, 
        // Amount is converted to the smallest currency unit (e.g., cents/paise) by multiplying by 100. For example, $1 = 100 cents or ₹1 = 100 paise.
